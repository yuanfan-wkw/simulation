function [sys,x0,str,ts,simStateCompliance]=hosmo_x2_2(t,x,u,flag)
%选择函数执行
switch flag
...
v0=-60*abs(x(1)-u(1))^(2/3)*sign(x(1)-u(1))+x(2);

sys(1)=v0;

v1=-80*abs(x(2)-v0)^(1/2)*sign(x(2)-v0)+x(3);

sys(2)=v1;

sys(3)=-120*sign(x(3)-v1);
end
