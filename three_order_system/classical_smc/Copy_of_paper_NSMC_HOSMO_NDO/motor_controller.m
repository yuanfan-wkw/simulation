...
sizes.NumInputs      = 5;    %x1 x2 x3 x1d compensation
...
F=0.01*u(3)*exp(-0.5*u(2));

s1=(u(4)+d2+dd1-ddx1d)+(c0+c1)*(u(3)+d1-dx1d)+c0*c1*(u(2)-x1d);



sys(1)=-1/5*(u(2)*u(3)*u(4)+u(2)*sin(u(2))+F-dddx1d+(c0+c1)*(u(4)-ddx1d)+c0*c1*(u(3)-dx1d)+u(5)+s1+1/pi*atan(30*s1));
end
